...
import './header.css'
import { faBed, faCalendarDays, faCar, faPeopleGroup, faPlane, faPlaneDeparture, faTaxi } from '@fortawesome/free-solid-svg-icons'
                                ...
                                {openOption && <div className="options">
                                    <div className="optionItem">
                                        ...
                                        <div className="optionCounter">
                                            <button disabled={option.adult === 0} className="optionCounterButton" onClick={() => handleOption("adult", "d")}>-</button>
                                            <span className="optionCouternumber">{option.adult}</span>
                                    ...
                                    <div className="optionItem">
                                        ...
                                        <div className="optionCounter">
                                            ...
                                            <span className="optionCouternumber">{option.children}</span>
                                    ...
                                    <div className="optionItem">
                                        ...
                                        <div className="optionCounter">
                                            ...
                                            <span className="optionCouternumber">{option.room}</span>
